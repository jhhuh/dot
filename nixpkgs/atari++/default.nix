{ stdenv, fetchurl, libSM, libX11, libXext, SDL, makeWrapper }:
...
stdenv.mkDerivation rec{
  ...
  buildInputs = [ libSM libX11 libXext SDL ];

  postInstall = ''
    wrapProgram $out/bin/atari++ --prefix LD_LIBRARY_PATH : "${libX11.out}/lib:${libXext.out}/lib"
  '';
